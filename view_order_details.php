...
<div class="container">
    <div class="container">
        ...
        <a href="view_order_details.php" class="list-group-item active">View Order Report</a>
    	</div>
    </div>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> YOUR FOOD ORDER REPORT </h3>
