<html>
<head>
    <title> Guest Signup | Online Food Restaurant </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit"> La Moosh </span></h1>
     <br>
   <center><p style="color:red">Get started by creating your account</p></center>
    </div>
    </div>
